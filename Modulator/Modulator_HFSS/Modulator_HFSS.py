...
def test_hfss_server():
    ...
    #
    # try:
    #     cl1 = create_session("whisky")
    #     if not isinstance(cl1, bool):
    #         cl1.aedt(port=50000, non_graphical=False)
    #         hfss = Hfss(machine="whisky", port=50000)
    #         hfss.close_desktop()
    #         # your code here
    # except:
    #     traceback.print_exc()
    ...
    # import rpyc
    #
    # client = rpyc.connect("whisky", 17878, config={"allow_public_attrs": True, "sync_request_timeout": None},)
    # print(type(client))
    # client_port = None
    #
    # # client = rpyc.core.protocol.Connection()
    # print(type(client.root))
    # if not client_port:
